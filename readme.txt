...
Tags: notification, notify, jquery, popup, message, notices, notifications, notice
...
1. Add a shortcode to a post or use the template tag in your theme
...
*   Options pane
*   Close button
*   Check for duplicate instances of pane
*   Additional styles